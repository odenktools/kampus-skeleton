...
return [
    ...
    'action' => [
        ...
        'exists' => ':title cannot be deleted. :title has children.',
        'failed' => 'Create :title failed, please check your input.',
        'queued' => ':title has been queued and will be send after a couple minutes.',
    ],
    ...
    'api' => [
        ...
        'error' => 'Error saat melakukan request.',
    ]
];
